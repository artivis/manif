...
copyright = "%s MIT license, %s" % (datetime.date.today().year, author)
...
ogp_site_url = "https://artivis.github.io/manif/"
...
# ogp_image = ".sphinx/_static/favicon.png"
...
html_context = {
    ...
    "product_page": "github.com/artivis/manif",
    # Product tag image; the orange part of your logo, shown in the page header
    #
    # TODO: To add a tag image, uncomment and update as needed.
    'product_tag': '_static/favicon.png',
    ...
    "github_url": "https://github.com/artivis/manif",
    # Docs branch in the repo; used in links for viewing the source files
    #
    # TODO: To customise the branch, uncomment and update as needed.
    'repo_default_branch': 'devel',
...
#
html_theme_options = {
    'source_edit_link': 'https://github.com/artivis/manif',
}
...
breathe_default_project = "manif"
breathe_projects = {"manif": "_build/doxyxml"}

# Setup the exhale extension
exhale_args = {
    # These arguments are required
    "containmentFolder":     "./api",
    "rootFileName":          "manif_api.rst",
